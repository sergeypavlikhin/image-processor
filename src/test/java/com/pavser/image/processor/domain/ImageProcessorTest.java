...
public class ImageProcessorTest {
    ...
    public void successProcessImage() throws ImageProcessorException {
        ...
        doReturn(FILE_NAE).when(sut).getResultFileName(any());
        ...
        verify(bufferedImageHelper).save(FILE_NAE, out);
    ...
    @Test
    public void getResultFileNameTest() {
         assertTrue(sut.getResultFileName("file:/D:/bla/bla/bla.jpg").endsWith(".jpg"));
         assertTrue(sut.getResultFileName("file:/D:/bla/bla/bla.gif").endsWith(".jpg"));
         assertTrue(sut.getResultFileName("file:/bla/bla/bla.gif").endsWith(".jpg"));
         assertTrue(sut.getResultFileName("http://bbb.bb/jjXXpp").endsWith(".jpg"));
         assertTrue(sut.getResultFileName("http://bbb.bb/jjXXpp.gif").endsWith(".jpg"));
         assertTrue(sut.getResultFileName("http://bbb.bb/jjXXpp.jpg").endsWith(".jpg"));
         assertTrue(sut.getResultFileName("http://bbb.bb/jjXXpp.jpeg").endsWith(".jpeg"));
         assertTrue(sut.getResultFileName("http://bbb.bb/jjXXpp.png").endsWith(".png"));
    }
